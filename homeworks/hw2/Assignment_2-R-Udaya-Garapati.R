...
# Write an IF statement that prints "CMSC 691 is assigned to TextVar" if TextVar is equal to "CMSC 691"
if (TextVar == "CMSC 691"){
  print("cmsc 691 is assigned to TextVar")
}
...
Tipping = read_tsv(file = "C:\\Users\\udaya\\Desktop\\Spring2023\\cmsc462\\homeworks\\hw2\\Tipping Data.txt" )
...
filter(Tipping, sex=="Male",time == "Dinner", day=="Sat" | day=="Sun")
...
# Enter your code below:
Tipping %>% group_by(sex) %>% summarise(Avg <- mean(tip))
